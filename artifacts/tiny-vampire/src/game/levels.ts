...
const level1: Level = {
  ...
  theme: {
    ...
    music: "sushi",
    sunStage: 1,
    sunLine: "Most travelers stop for lunch.",
  },
  worldW: 3000,
  worldH: WORLD_H,
  spawn: { x: 60, y: 440 },
  ...
  collectibles: [
    { x: 360, y: 360, w: 22, h: 22, kind: "memory", id: "l1m1", label: "Koi Scale", desc: "A shimmering scale from the giant festival koi." },
    { x: 1120, y: 380, w: 22, h: 22, kind: "memory", id: "l1m2", label: "First Firefly", desc: "The first firefly of the season, blinking awake." },
    { x: 1240, y: 404, w: 20, h: 26, kind: "note", id: "l1n1", secret: true, label: "Encrypted Note I" },
    { x: 1560, y: 420, w: 22, h: 22, kind: "token", id: "l1t1" },
    { x: 2150, y: 320, w: 22, h: 22, kind: "memory", id: "l1m3", secret: true, label: "Rooftop Moon", desc: "A sliver of moon caught on a sushi-bar rooftop." },
    { x: 2660, y: 360, w: 26, h: 26, kind: "postcard", id: "l1s1", secret: true, label: "Postcard: Sushi District", desc: "Having a wonderful time. Wish you were asleep. — Your Coffin" },
  ],
  bouncePads: [],
...
const level2: Level = {
  ...
  theme: {
    ...
    music: "beach",
    sunStage: 2,
    sunLine: "Humans celebrate the strangest things.",
  },
  worldW: 3100,
  worldH: WORLD_H,
  spawn: { x: 60, y: 440 },
  ...
  collectibles: [
    { x: 700, y: 360, w: 22, h: 22, kind: "memory", id: "l2m1", label: "Broken Flip-Flop", desc: "One sandal, strap snapped, sole still warm from the boardwalk." },
    { x: 1010, y: 300, w: 22, h: 22, kind: "token", id: "l2t1" },
    { x: 1250, y: 360, w: 22, h: 22, kind: "memory", id: "l2m2", label: "Lost Beach Ball", desc: "A faded beach ball that drifted in on the tide." },
    { x: 1010, y: 334, w: 20, h: 26, kind: "note", id: "l2n1", secret: true, label: "Encrypted Note II" },
    { x: 1510, y: 270, w: 22, h: 22, kind: "memory", id: "l2m3", secret: true, label: "High Tide Moon", desc: "A moon that only shows itself at the highest tide." },
    { x: 2200, y: 360, w: 22, h: 22, kind: "token", id: "l2t2" },
    { x: 2760, y: 360, w: 26, h: 26, kind: "postcard", id: "l2s1", secret: true, label: "Postcard: Sunny Boardwalk", desc: "The beach is lovely. — Your Coffin" },
  ],
  bouncePads: [
...
const level3: Level = {
  ...
  theme: {
    ...
    music: "pride",
    sunStage: 3,
    sunLine: "What a beautiful display.",
  },
  worldW: 2600,
  worldH: WORLD_H,
  spawn: { x: 60, y: 440 },
  ...
  collectibles: [
    { x: 600, y: 380, w: 22, h: 22, kind: "memory", id: "l3m1", label: "Rainbow Ribbon", desc: "A streamer of every color, still fluttering." },
    { x: 1180, y: 380, w: 22, h: 22, kind: "token", id: "l3t1" },
    { x: 1300, y: 300, w: 22, h: 22, kind: "memory", id: "l3m2", secret: true, label: "Confetti Moon", desc: "A moon made of a thousand tiny paper hearts." },
    { x: 1980, y: 474, w: 20, h: 26, kind: "note", id: "l3n1", secret: true, label: "Encrypted Note III" },
    { x: 2120, y: 380, w: 26, h: 26, kind: "postcard", id: "l3s1", secret: true, label: "Postcard: Parade Route", desc: "Met some colorful people today. — Your Coffin" },
  ],
  bouncePads: [],
...
const level4: Level = {
  ...
  theme: {
    ...
    music: "turing",
    sunStage: 4,
    sunLine: "Some puzzles outlive their creators.",
  },
  worldW: 2400,
  worldH: WORLD_H,
  spawn: { x: 60, y: 440 },
  ...
  collectibles: [
    { x: 640, y: 320, w: 22, h: 22, kind: "memory", id: "l4m1", label: "Festival Ticket", desc: "A ticket stub to a show that outlived its inventor." },
    { x: 900, y: 360, w: 22, h: 22, kind: "token", id: "l4t1" },
    { x: 1540, y: 360, w: 22, h: 22, kind: "memory", id: "l4m2", label: "Paper Lantern", desc: "A hand-folded lantern, warm and patient." },
    { x: 1540, y: 384, w: 20, h: 26, kind: "note", id: "l4n1", secret: true, label: "Encrypted Note IV" },
    { x: 1740, y: 300, w: 22, h: 22, kind: "memory", id: "l4m3", secret: true, label: "Enigma Moon", desc: "A moon encoded in a riddle no one else could read." },
    { x: 2040, y: 380, w: 26, h: 26, kind: "postcard", id: "l4s1", secret: true, label: "Postcard: The Garden", desc: "Found a puzzle. Regret everything. — Your Coffin" },
  ],
  bouncePads: [],
...
const level5: Level = {
  ...
  theme: {
    ...
    music: "afternoon",
    sunStage: 5,
    sunLine: "You've come farther than I expected.",
  },
  worldW: 2900,
  worldH: WORLD_H,
  spawn: { x: 50, y: 440 },
  ...
  collectibles: [
    ...
    { x: 1160, y: 360, w: 22, h: 22, kind: "memory", id: "l5m1", label: "Sunset Photograph", desc: "A snapshot of a sky that hasn't happened yet." },
    { x: 1600, y: 380, w: 22, h: 22, kind: "token", id: "l5t2" },
    { x: 2050, y: 360, w: 22, h: 22, kind: "memory", id: "l5m2", label: "Paper Fan", desc: "A little fan someone dropped while fleeing the heat." },
    { x: 2450, y: 474, w: 20, h: 26, kind: "note", id: "l5n1", secret: true, label: "Encrypted Note V" },
    { x: 2400, y: 430, w: 22, h: 22, kind: "memory", id: "l5m3", secret: true, label: "Mirage Moon", desc: "A moon that wavers in the heat — real, somehow." },
    { x: 2730, y: 380, w: 26, h: 26, kind: "postcard", id: "l5s1", secret: true, label: "Postcard: Heatwave Plaza", desc: "It is extremely warm in here. Send a nap. — Your Coffin" },
  ],
  bouncePads: [],
...
const level6: Level = {
  ...
  movingShade: [],
  collectibles: [
    { x: 1200, y: 470, w: 22, h: 22, kind: "memory", id: "l6m1", label: "Moon Fragment", desc: "The last fragment of moon, finally yours." },
    { x: 1750, y: 474, w: 20, h: 26, kind: "note", id: "l6n1", secret: true, label: "Encrypted Note VI" },
    { x: 2300, y: 470, w: 26, h: 26, kind: "postcard", id: "l6s1", secret: true, label: "Postcard: Almost Home", desc: "Almost home. — Your Coffin" },
  ],
  bouncePads: [],
  checkpoints: [],
  npcs: [
